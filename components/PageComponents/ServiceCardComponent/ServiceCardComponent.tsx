...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Security System Needs',
  subheading = 'From emergency repairs to new doors and openers, WatchPoint Security handles it all — on time, on price.',
