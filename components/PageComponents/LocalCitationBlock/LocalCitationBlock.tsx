...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'WatchPoint Security',
  address       = 'Waco, TX 76707',
  phone         = '(254) 910-1212',
  email         = 'hello@watchpointsecurity.com',
  googleMapsUrl = 'https://maps.google.com/?q=WatchPoint+Security+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
    <section
      ...
      itemScope
      itemType="https://schema.org/SecurityBusiness"
    >
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed security technicians.
          </p>
        </div>
