...
const INDUSTRIES = [
  { slug: 'retail',                label: 'Retail Stores',              icon: faStore },
  { slug: 'property-management',   label: 'Property Management',        icon: faBuilding },
  { slug: 'warehouses',            label: 'Warehouses & Logistics',     icon: faWarehouse },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Security programs — built for how your industry actually works.',
  disableLinks = false,
