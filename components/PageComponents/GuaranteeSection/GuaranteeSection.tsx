...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "24/7 Monitoring Options · Workmanship Guaranteed",
    description:
      "Every installation we perform is covered by our workmanship guarantee. Optional professional monitoring available — no long-term lock-in required.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every security technician who enters your home is licensed. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every security company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, licensed technicians, and workmanship guaranteed on every install we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 1,300+ verified Google reviews</span>
          </div>
        </div>
