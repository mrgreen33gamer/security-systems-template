...
// WatchPoint Security — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full security system repair, burglar alarms, track and hardware, lighting, door maintenances, and monitoring plans across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full security system coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'system upgrades'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and 24/7 Monitoring Options · Workmanship Guaranteed as every other area we cover.",
    highlights:  ['Flat-rate pricing', '24/7 Monitoring Options · Workmanship Guaranteed', 'licensed'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable security system service for Bellmead residents and businesses. system upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'licensed security technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential security system service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Security System repair, burglar alarms, and shop power for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'system upgrades', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Security System repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service security system coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial security system.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial security system in all areas?',
    answer: 'Yes — light commercial security system for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Security — Since 2008
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, licensed security technicians, and a 24/7 Monitoring Options · Workmanship Guaranteed — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549101212" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common security system issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549101212" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549101212" className={styles.unlistedCTA}>
            Call (254) 910-1212
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, 24/7 Monitoring Options · Workmanship Guaranteed, no contracts ever."
