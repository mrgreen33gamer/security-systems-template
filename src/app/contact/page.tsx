...
// WatchPoint Security — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Security Cameras', 'Burglar Alarms', 'Access Control',
  'Video Doorbells', 'Smart Home Security', 'Monitoring Plans',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 910-1212. We answer 7 days a week including evenings. For a genuine security system emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial security systems?',
    answer: 'Yes — retail, offices, multi-unit, and warehouses are within our scope. Call to discuss your specific cameras, access control, or monitoring needs.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our tech will tell you honestly after the assessment. If repair costs approach the price of a clean new system, we'll recommend replacement — but we'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@watchpointsecurity.com',
                  href:      'mailto:hello@watchpointsecurity.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '2500 W Waco Dr, Waco TX 76707',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose WatchPoint Security</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'licensed security technicians only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed WatchPoint Security security technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549101212">(254) 910-1212</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 910-1212 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 910-1212"
        primaryLink="tel:+12549101212"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549101212"
      />
